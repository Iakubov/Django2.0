...
urlpatterns = [
    ...
    re_path(r'^shopuser/update/(?P<pk>\d+)/$', adminapp.shopuser_update,
            name='shopuser_update'),
    re_path(r'^shopuser/delete/(?P<pk>\d+)/$', adminapp.shopuser_delete,
    ...
    re_path(r'^product/delete/(?P<pk>\d+)/$', adminapp.product_delete,
            name='product_delete'),
    re_path(r'^product/read/(?P<pk>\d+)/$', adminapp.product_read,
            name='product_read'),
